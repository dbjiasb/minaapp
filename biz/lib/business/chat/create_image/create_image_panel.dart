            ...
            child: Obx(
              () => Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 13,
                    color: (index == viewController.selectedIndex.value) ? const Color(0xFF07070A) : Colors.white,
          ...
          children: [
            Flexible(
              child: Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(16), color: const Color(0xFF252329)),
                                  ...
                                  () => Container(
                                    ...
                                    decoration:
                                        (e == viewController.config.value.prompts[index].selectedItem.value)
                                            ? BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(8))
                                            : BoxDecoration(borderRadius: BorderRadius.circular(8), color: Colors.white10),
                                    child: Text(
                                      e[Security.security_desc] ?? '',
                                      style: TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 12,
                                        color: (e == viewController.config.value.prompts[index].selectedItem.value) ? Color(0xFF07070A) : const Color(0xFFA19C9A),
                                      ),
                                    ),
                                  ),
                                ),
      ...
      child: Container(
        ...
        child: GestureDetector(
          ...
          child: Container(
            height: 44,
            alignment: Alignment.center,
            decoration: BoxDecoration(color: Color(0xFFFFF37C), borderRadius: BorderRadius.circular(12)),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(Security.security_Create, style: TextStyle(fontSize: 14, color: Color(0xFF07070A), fontWeight: FontWeight.w900)),
                Container(padding: const EdgeInsets.symmetric(horizontal: 4), child: ImageView(viewController.currencyIcon, width: 16, height: 16)),
                Text(viewController.price.toString(), style: const TextStyle(fontSize: 14, color: Color(0xFF07070A), fontWeight: FontWeight.w900)),
              ],
            ),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Color(0xFF1A181E), borderRadius: BorderRadius.only(topLeft: Radius.circular(24), topRight: Radius.circular(24))),
        child: Stack(
          children: [
            Column(
              children: [
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(Copywriting.security_images_you_like, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.white)),
                      BalanceView(
                        type: BalanceType.coin,
                        style: BalanceViewStyle(color: AppColors.primary, bgColor: Colors.white10, borderRadius: 8, height: 24, padding: 8),
                      ),
                    ],
                  ),
                ),
                Divider(height: 1, color: Colors.white10),
                SizedBox(height: 44, child: TabBar(
                    ...
                    tabs: [Security.security_select,Security.security_enter].map((e) {
                      final index  = [Security.security_select,Security.security_enter].indexOf(e);
                      return Tab(
                        child: Obx(() {
                          bool isSelected = viewController.typeIndex.value == index;
                          return Stack(
                            alignment: Alignment.bottomRight,
                            clipBehavior: Clip.none,
                            children: [
                              Text(e, style: TextStyle(color: isSelected ? Colors.white : Color(0xFFA19C9A), fontSize: 14, fontWeight: FontWeight.bold)),
                              // Positioned(
                              //     bottom: -6,
                              //     child: isSelected
                ...
                Expanded(child: Obx(() => viewController.typeIndex.value == 0 ? buildSelectView() : buildEnterView())),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: Copywriting.security_enter_your_image_prompt__e_g__A_girl__sitting_on_a_bench___,
        ...
        Container(
          ...
          child: Obx(
              ...
              itemBuilder: (ctx, index) {
                Map<String, dynamic> item = viewController.selectedItems[index] ?? {};
                if (item.isEmpty) return SizedBox();
                return Container(
                  padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                  alignment: Alignment.center,
                  decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(8)),
                  child: Text(item[Security.security_desc] ?? '', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFF07070A))),
                ).marginOnly(right: 8);
              },
...
class CreateImagePanelController extends GetxController  with GetTickerProviderStateMixin{
  ...
  void createImage() async {
    ...
    ApiResponse response = await CreateImageManager.instance.createImage(Get.find<ChatRoomViewController>().userId, options, imgPrompt);
  ...
  List get selectedItems => config.value.prompts.map((e) {
